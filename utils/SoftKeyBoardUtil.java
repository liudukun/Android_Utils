...
public class SoftKeyBoardUtil {
    ...
    private static SharedPreferences preferences = DKApplication.sharedInstance().getSharedPreferences("DKChat", Context.MODE_PRIVATE);
    private static InputMethodManager imm = (InputMethodManager) DKApplication.sharedInstance().getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        ViewTreeObserver.OnGlobalLayoutListener listener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (rootViewVisibleHeight - visibleHeight > 200) {
                    ...
                    preferences.edit().putInt(Constant.SOFT_KEY_BOARD_HEIGHT, softKeyBoardHeight).apply();
                    return;
                }
    ...
    public static int getSoftKeyBoardHeight() {
        ...
        softKeyBoardHeight = preferences.getInt(Constant.SOFT_KEY_BOARD_HEIGHT, 0);
        if (softKeyBoardHeight == 0) {
