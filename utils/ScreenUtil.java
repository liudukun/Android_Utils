...
public class ScreenUtil {
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = DKApplication.sharedInstance().getResources();
    ...
    public static int[] getScreenSize() {
        int size[] = new int[2];
        DisplayMetrics dm = DKApplication.sharedInstance().getResources().getDisplayMetrics();
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = DKApplication.sharedInstance().getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = DKApplication.sharedInstance().getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
    ...
    public static int getPxByDp(float dp) {
        float scale = DKApplication.sharedInstance().getResources().getDisplayMetrics().density;
    ...
    public static int[] scaledSize(int containerWidth, int containerHeight, int realWidth, int realHeight) {
        DKLog.d(TAG, "scaledSize  containerWidth: " + containerWidth + " containerHeight: " + containerHeight
